  ...
  fn.extend({
    jqPosition: function () {
      ...
      if (cashEl.css("position") === "fixed") {
        ...
        while (oP && (oP === doc.body || oP === docEl) && cashOP.css("position") === "static") {
          oP = oP.parentNode;
        }
      ...
      return {
        top: offset.top - parentOffset.top - (parseInt(cashEl.css("marginTop"), 10) || 0),
        left: offset.left - parentOffset.left - (parseInt(cashEl.css("marginLeft"), 10) || 0)
      };
    }
